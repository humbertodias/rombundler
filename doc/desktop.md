...
The sample checked into the repo is `src/platforms/desktop/config.ini` (copied into desktop zips). Nintendo Switch: [switch.md](switch.md). PlayStation Vita: [vita.md](vita.md).
